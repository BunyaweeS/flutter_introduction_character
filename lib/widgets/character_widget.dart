import 'package:despicable/models/character.dart';
import 'package:despicable/pages/character_detail_screen.dart';
      ...
      onTap: () {
        Navigator.push(
            ...
            PageRouteBuilder(
                ...
                pageBuilder: (context, _, __) => CharacterDetailScreen(character: characters[0], key: ValueKey('character_detail_screen'),)));
      },
      child: Stack(
        children: [
          Align(
